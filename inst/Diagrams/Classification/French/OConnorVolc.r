...
template<-list(
        clssf=list("NULL",use=2:6,rcname=c("quartzkératophyre","rhyolite","latite quartzifere","rhyodacite","dacite")),
...
temp<-list(        
        text1=list("text",x=20,y=sqrt(3)*10/2,text="Quartz-\nkératophyre",col=plt.col[2]),
        text2=list("text",x=40+7/2,y=sqrt(3)*7/2,text="Rhyolite",col=plt.col[2]),
        text3=list("text",x=42+25/2,y=sqrt(3)*25/2,text="Latite\nquartzifere",col=plt.col[2],srt=60),
        text4=list("text",x=27+30/2,y=sqrt(3)*30/2,text="Rhyodacite",col=plt.col[2],srt=60),
        text5=list("text",x=10+40/2,y=sqrt(3)*40/2,text="Dacite",col=plt.col[2])
        )
