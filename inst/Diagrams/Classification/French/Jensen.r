...
template=list(
        clssf=list("NULL",use=2:12,rcname=c("TH - Rhyolite","TH - Dacite","TH - Andésite","CA - Rhyolite","CA - Dacite","CA - Andésite","CA - Basalte","TH - Basaltee tholéitique magnésien","KO - Komatiitic basalte","KO - Komatiite s.s.","TH - Basaltee tholéitique ferreux")),
...
#        lines26=list("lines",x=c(0.320,0.443),y=c(0.3983717,0.3464102),col=plt.col[2],lty="dashed"),  # dtto
  ...
  if(getOption("gcd.plot.text")){
        ...
        text4=list("text",x=0.39,y=0.40,text="Basaltee\ntholéitique\nferreux",cex=0.85,col=plt.col[2]),
        text5=list("text",x=0.26,y=0.32,text="Andésite",srt=-60,cex=0.85,col=plt.col[2]),
        ...
        text10=list("text",x=0.285,y=0.117,text="Andésite",srt=-60,cex=0.85,col=plt.col[2]),
        text11=list("text",x=0.35,y=0.163,text="Basalte",srt=-60,cex=0.85,col=plt.col[2]),
        text12=list("text",x=0.445,y=0.17,text="Basaltee\ntholéitique\nmagnésien",cex=0.7,col=plt.col[2]),
        text13=list("text",x=0.625,y=0.29,text="Basaltee\nkomatiitique",srt=-60,col=plt.col[2]),
