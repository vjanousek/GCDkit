...
template<-list(
clssf=list("NULL",use=2:28,rcname=c("quartzolite","granitoide riche en quartz","alk-fsp. granite","syénogranite","monzogranite","granodiorite","tonalite","syénite qz. a fsp. alc","syénite quartzifere","quartzmonzonite","qz. monzonite qz. monzogabbro","qz. diorite qz. gabbro qz. anorthosite","syénite a fsp. alc.","syénite","monzonite","monzodiorite/monzogabbro","diorite gabbro anorthosite","syénite a fsp. alc et a feldspathoides","syénite a feldspathoides","monzonite a feldspathoides","monzodiorite/monzogabbro a feldspathoides","foid-bearing-diorite foid-bearing-gabbro foid-bearing-anorthosite","syénite\nfeldspathoidique","monzosyénite feldspathoidique","monzosyénite feldspathoidique monzogabbro","diorite/gabbro feldspathoidique","feldsphathoidite")),
...
text4=list("text",x=34,y=35,text="syéno-\ngranite",col=plt.col[2]),
...
text8=list("text",x=10,y=11,text="syénite\nqz. a fsp. alc",col=plt.col[2],adj=1),
text9=list("text",x=27,y=11,text="syénite\nquartzifere",col=plt.col[2]),
...
text14=list("text",x=22,y=2,text="syénite",col=plt.col[2],adj=0.5),
...
text18=list("text",x=0,y=80,text="1 - syénite\na fsp. alc.",col=plt.col[2],adj=0),
...
text22=list("text",x=22,y=-4,text="syénite\na feldspathoides",col=plt.col[2],adj=0.5),
...
text26=list("text",x=23,y=-35,text="syénite\nfeldspathoidique",col=plt.col[2],adj=0.5,srt=-60),
text27=list("text",x=37,y=-20,text="monzosyénite\nfeldspathoidique",col=plt.col[2],adj=0.5),
text28=list("text",x=63,y=-20,text="monzosyénite\nmonzogabbro\nfeldspathoidique",col=plt.col[2],adj=0.5),
...
text34=list("text",x=0,y=-60,text="4 - syénite a fsp. alc\net a feldspathoides",col=plt.col[2],adj=0),
