...
template=list(
    clssf=list("NULL",use=2:11,rcname=c("Tr.An.","Basanite/Trachybasanite/Nephelinite","Phonolite","Trachyte","Comendite/Pantellerite","Rhyolite","Rhyodacite/Dacite","Andésite","Sub-AB","AB")),
...
if(getOption("gcd.plot.text")){
    ...
    text1=list("text",x=1,y=55,text="Phonolite",col=plt.col[2],cex=1,adj=0),
    text1=list("text",x=1,y=65,text="Trachyte",col=plt.col[2],cex=1,adj=0),
    text1=list("text",x=0.002,y=75,text="Rhyolite",col=plt.col[2],cex=1,adj=0),
   #text1=list("text",x=0.02,y=60,text="Andésite",col=plt.col[2],cex=1,adj=0),
    text1=list("text",x=0.002,y=70,text="Rhyodacite\nDacite",col=plt.col[2],cex=1,adj=0),
    text1=list("text",x=0.002,y=50,text="Sub-AB",col=plt.col[2],cex=1,adj=0),
    text1=list("text",x=0.04,y=60.5,text="Tr.An.",col=plt.col[2],cex=1,adj=0),
    text1=list("text",x=0.007,y=46,text="AB",col=plt.col[2],cex=1,adj=0),
    text1=list("text",x=1,y=75,text="Comendite\nPantellerite",col=plt.col[2],cex=1,adj=0),
    text1=list("text",x=0.03,y=46,text="Basanite\nTrachybasanite\nNephelinite",col=plt.col[2],cex=1,adj=0),
    text1=list("text",x=.002,y=60,text="Andésite",col=plt.col[2],cex=1,adj=0)))
}
...
sheet<<-list(demo=list(fun="plot",call=list(xlim=c(0.001,10),ylim=c(40,80),main=annotate("Diagramme Zr/TiO2 - SiO2 (Winchester and Floyd 1977)"),bg="transparent",fg="black",asp=1,axes=TRUE,log="x",xlab=annotate("Zr/TiO2"),ylab=annotate("SiO2")),template=template))
