...
temp1<-list(
        clssf=list("NULL",use=2:16,rcname=c("feldspathoidite","picrobasaltee","basalte","andésite basalteique","andésite","dacite","rhyolite","trachybasaltee","trachyandésite basalteique","trachyandésite","trachyte/trachydacite","téphrite/basanite","phonotéphrite","téphriphonolite","phonolite")),
...
temp2<-list(
        text1=list("text",x=43,y=1.55,text="Picrobasalte",col=plt.col[2],srt=90,cex=0.8),
        ...
        text11=list("text",x=45,y=7,text="Téphrite\nBasanite",col=plt.col[2]),
        text12=list("text",x=49.2,y=9.3,text="Phono-\ntéphrite",col=plt.col[2]),
        text13=list("text",x=53,y=11.5,text="Téphri-\nphonolite",col=plt.col[2]),
        text14=list("text",x=57,y=14,text="Phonolite",col=plt.col[2]),
        text15=list("text",x=43,y=12,text="Feldspathoidite",col=plt.col[2]),
        text16=list("text",x=38,y=2,text="Alcalin",col=plt.col[2],srt=45),
        text17=list("text",x=55,y=1,text="Subalcalin/Tholéitique",col=plt.col[2],srt=5),
        text18=list("text",x=41,y=15.5,text="Ultrabasique",col=plt.col[3]),
        text19=list("text",x=49,y=15.5,text="Basique",col=plt.col[3]),
        text20=list("text",x=58,y=15.5,text="Intermédiaire",col=plt.col[3]),
        text21=list("text",x=67,y=15.5,text="Acide",col=plt.col[3])
        )
