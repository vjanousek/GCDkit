...
temp1<-list(
        clssf=list("NULL",use=2:5,rcname=c("série tholéitique","série calco-alcaline","high-K série calco-alcaline","série shoshonitique")),
...
temp3<-list(
        text1=list("text",x=77,y=0.7,text="Série tholéitique",col=plt.col[2],adj=c(1,0.5)),
        text2=list("text",x=77,y=2.4,text="Série calco-alcaline",col=plt.col[2],adj=c(1,0.5)),
        text3=list("text",x=77,y=4,text="Série calco-alcaline\npotassique",col=plt.col[2],adj=c(1,0.5)),
        text4=list("text",x=47,y=4.5,text="Série shoshonitique",col=plt.col[2],adj=0)
    )
...
sheet<<-list(demo=list(fun="plot",call=list(xlim=c(45,78),ylim=c(0,7),main=annotate("Diagramme SiO2-K2O (Pecerillo et Taylor 1976)"),col="green",bg="transparent",fg="black",xlab=annotate("SiO2"),ylab=annotate("K2O")),template=temp))
}
