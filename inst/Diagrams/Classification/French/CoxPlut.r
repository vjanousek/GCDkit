...
template<-list(
      clssf=list("NULL",use=2:12,rcname=c("gabbro","gabbro","diorite","diorite quartzifere (granodiorite)","granite","indéfini","indéfini","syénodiorite","syénite","ijolite","syénite néphélinique")),
...
if(alkline){
    ...
    if(getOption("gcd.plot.text")){
        template<-c(template,list(
            text11=list("text",x=38.5,y=2,text="Alcalin",col=plt.col[3],font=4),
