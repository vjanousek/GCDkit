...
temp1<-list(
        clssf=list("NULL",use=2:15,rcname=c("D, Gb","monzodiorite","monzonite","syénite","alk.fsp. syénite","diorite","qtz monzodiorite","qtz. monzonite","qtz syénite","alk.fsp. qtz syénite","tonalite","granodirite","granite","alk.fsp. granite")),
...
temp2<-list(
        text1=list("text",x=61,y=12,text="Alk.Fsp.\nSyénite",col=plt.col[2],cex=0.75),
        text2=list("text",x=65,y=11.5,text="Alk.Fsp.\nQtz\nSyénite",col=plt.col[2],cex=0.75),
        text3=list("text",x=70,y=10.5,text="Alk.Fsp.\nGranite",col=plt.col[2],cex=0.75),
        text4=list("text",x=59.5,y=10,text="Syénite",col=plt.col[2],cex=0.75,srt=45),
