...
template<-list(
      clssf=list("NULL",use=2:16,rcname=c("basalt","basaltic andesite","andesite","dacite","rhyolite","hawaiite","trachyandesite","basanite/tephrite","mugearite","benmoreite","trachyte","nephelinite","phonolitic nephelinite","phonolitic tephrite","phonolite")),
...
if(getOption("gcd.plot.text")){
    template<-c(template,list(
        ...
        text3=list("text",x=59,y=4.5,text="Andesite",col=plt.col[2]),
        text4=list("text",x=48,y=4,text="Basalt",col=plt.col[2]),
        text5=list("text",x=64,y=11.5,text="Trachyte",col=plt.col[2]),
        text6=list("text",x=51.5,y=8,text="Mugearite",col=plt.col[2]),
        text7=list("text",x=56,y=13.5,text="Phonolite",col=plt.col[2]),
        text8=list("text",x=49.1,y=6.3,text="Hawaiite",col=plt.col[2]),
        text9=list("text", x=39.5,y=7,text="Nephelinite",col=plt.col[2]),
        text11=list("text",x=59,y=8,text="Trachy-\nandesite",col=plt.col[2],cex=1),
        text12=list("text",x=53.5,y=4,text="Basaltic\nandesite",col=plt.col[2],cex=1,srt=90),
        text13=list("text",x=56.5,y=10,text="Benmoreite",col=plt.col[2],cex=1),
        text14=list("text",x=45,y=11,text="Phonolitic\nnephelinite",col=plt.col[2],cex=1,srt=45),
        text15=list("text",x=50,y=10.4,text="Phonolitic\ntephrite",col=plt.col[2],cex=1,srt=45),
...
if(alkline){
    ...
    if(getOption("gcd.plot.text")){
        template<-c(template,list(
            text11=list("text",x=39,y=2,text="Alkaline",col=plt.col[3],font=4),
            text12=list("text",x=42,y=1,text="Subalkaline/Tholeiitic",col=plt.col[3],adj=0,font=4),
            text13=list("text",x=40,y=16,text="Ultrabasic",col=plt.col[3]),
            text14=list("text",x=49,y=16,text="Basic",col=plt.col[3]),
            text15=list("text",x=58,y=16,text="Intermediate",col=plt.col[3]),
            text16=list("text",x=68,y=16,text="Acid",col=plt.col[3])
            )
        )
    }
}
