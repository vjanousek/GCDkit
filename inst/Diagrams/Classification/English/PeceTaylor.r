...
temp1<-list(
        clssf=list("NULL",use=2:5,rcname=c("tholeiite series","calc-alkaline series","high-K calc-alkaline series","shoshonite series")),
...
temp3<-list(
        text1=list("text",x=77,y=0.7,text="Tholeiite Series",col=plt.col[2],adj=c(1,0.5)),
        text2=list("text",x=77,y=2.4,text="Calc-alkaline\nSeries",col=plt.col[2],adj=c(1,0.5)),
        text3=list("text",x=77,y=4,text="High-K calc-alkaline\nSeries",col=plt.col[2],adj=c(1,0.5)),
        text4=list("text",x=47,y=4.5,text="Shoshonite Series",col=plt.col[2],adj=0)
    )
...
sheet<<-list(demo=list(fun="plot",call=list(xlim=c(45,78),ylim=c(0,7),main=annotate("SiO2-K2O plot (Peccerillo and Taylor 1976)"),col="green",bg="transparent",fg="black",xlab=annotate("SiO2"),ylab=annotate("K2O")),template=temp))
}
