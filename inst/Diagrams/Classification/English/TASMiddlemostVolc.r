...
temp1<-list(clssf=list("NULL",use=2:19,rcname=c("foidite","picrobasalt","basalt","basaltic andesite","andesite","dacite","rhyolite","trachybasalt","basaltic trachyandesite","trachyandesite","trachydacite","trachyte","tephrite","phonotephrite","tephriphonolite","phonolite","sodalitite/nephelinolith/leucitolith","silexite")),
...
temp2<-list(
        text1=list("text",x=43,y=1.4,text="Picro-\nbasalt",col=plt.col[2],srt=90),
        text2=list("text",x=48.5,y=2.8,text="Basalt",col=plt.col[2],srt=90),
        text3=list("text",x=54.8,y=3,text="Basaltic\nandesite",col=plt.col[2],srt=90),
        text4=list("text",x=59.9,y=3,text="Andesite",col=plt.col[2],srt=90),
        ...
        text8=list("text",x=57.8,y=8.5,text="Trachy-\nandesite",col=plt.col[2],cex=0.8),
        text9=list("text",x=52.95,y=7,text="Basaltic\ntrachy-\nandesite",col=plt.col[2],cex=0.8),
        text10=list("text",x=49.2,y=5.65,text="Trachy-\nbasalt",col=plt.col[2],cex=0.8),
        text11=list("text",x=45,y=7,text="Tephrite",col=plt.col[2],srt=50),
        text12=list("text",x=49.2,y=9.3,text="Phono-\ntephrite",col=plt.col[2],cex=0.8,srt=50),
        text13=list("text",x=53,y=11.5,text="Tephri-\nphonolite",col=plt.col[2],cex=0.8,srt=50),
        text14=list("text",x=57,y=15,text="Phonolite",col=plt.col[2]),
        text15=list("text",x=44,y=12,text="Foidite",col=plt.col[2]),
        text22=list("text",x=55,y=18.5,text="Sodalitite/Nephelinolith/Leucitolith",col=plt.col[2]),
...
sheet<<-list(demo=list(fun="plot",call=list(xlim=c(34,90),ylim=c(0,19),main=annotate("TAS (Middlemost 1994)"),col="green",bg="transparent",fg="black",xlab=annotate("SiO2"),ylab=annotate("Na2O+K2O")),main="TAS diagram for volcanics (Middlemost 1994)",template=temp))
}
