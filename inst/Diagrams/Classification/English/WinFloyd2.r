...
template=list(
    clssf=list("NULL",use=2:11,rcname=c("TrAn","Basanite/Trachybasanite/Nephelinite","Phonolite","Trachyte","Comendite/Pantellerite","Rhyolite","Rhyodacite/Dacite","Andesite","Sub-AB","AB")),
...
if(getOption("gcd.plot.text")){
   ...
   #text1=list("text",x=0.02,y=60,text="Andesite",col=plt.col[2],cex=1,adj=0),
    ...
    text1=list("text",x=.002,y=60,text="Andesite",col=plt.col[2],cex=1,adj=0)))
}
...
sheet<<-list(demo=list(fun="plot",call=list(xlim=c(0.001,10),ylim=c(40,80),main=annotate("Zr/TiO2 - SiO2 plot (Winchester and Floyd 1977)"),bg="transparent",fg="black",asp=1,axes=TRUE,log="x",xlab=annotate("Zr/TiO2"),ylab=annotate("SiO2")),template=template))
