...
temp1<-list(
        clssf=list("NULL",use=2:16,rcname=c("foidite","picrobasalt","basalt","basaltic andesite","andesite","dacite","rhyolite","trachybasalt","basaltic trachyandesite","trachyandesite","trachyte/trachydacite","tephrite/basanite","phonotephrite","tephriphonolite","phonolite")),
...
temp2<-list(
        text1=list("text",x=43,y=1.55,text="Picrobasalt",col=plt.col[2],srt=90,cex=0.8),
        ...
        text6=list("text",x=75,y=8.3,text="Rhyolite",col=plt.col[2]),
        text7=list("text",x=63.5,y=11.2,text="Trachyte\nTrachydacite",col=plt.col[2]),
        ...
        text11=list("text",x=45,y=7,text="Tephrite\nBasanite",col=plt.col[2]),
        text12=list("text",x=49.2,y=9.3,text="Phono-\ntephrite",col=plt.col[2]),
        text13=list("text",x=53,y=11.5,text="Tephri-\nphonolite",col=plt.col[2]),
        text14=list("text",x=57,y=14,text="Phonolite",col=plt.col[2]),
        text15=list("text",x=43,y=12,text="Foidite",col=plt.col[2]),
        text16=list("text",x=38,y=2,text="Alkaline",col=plt.col[2],srt=45),
        text17=list("text",x=55,y=1,text="Subalkaline/Tholeiitic",col=plt.col[2],srt=5),
        text18=list("text",x=41,y=15.5,text="Ultrabasic",col=plt.col[3]),
        text19=list("text",x=49,y=15.5,text="Basic",col=plt.col[3]),
        text20=list("text",x=58,y=15.5,text="Intermediate",col=plt.col[3]),
        text21=list("text",x=67,y=15.5,text="Acid",col=plt.col[3])
        )
