...
temp1<-list(
        clssf=list("NULL",use=2:19,rcname=c("foidolite","peridotgabbro","gabbro","gabbroic diorite","diorite","granodiorite","granite","monzogabbro","monzodiorite","monzonite","quartz monzonite","syenite","foid gabbro","foid monzodiorite","foid monzosyenite","foid syenite","tawite/urtite/italite","quartzolite")),
...
temp2<-list(
        ...
        text7=list("text",x=63.5,y=11.5,text="Syenite",col=plt.col[2],srt=45),
        ...
        text11=list("text",x=45,y=7,text="Foid\ngabbro",col=plt.col[2],srt=50),
        text12=list("text",x=49.2,y=9.3,text="Foid\nmonzo-\ngabbro",col=plt.col[2],srt=50,cex=0.8),
        text13=list("text",x=53,y=11.5,text="Foid\nmonzo-\nsyenite",col=plt.col[2],srt=50,cex=0.8),
        text14=list("text",x=57,y=14,text="Foid\nsyenite",col=plt.col[2],srt=50,cex=0.8),
        text15=list("text",x=44,y=12,text="Foidolite",col=plt.col[2]),
        ...
        #text16=list("text",x=40,y=14,text="Alkaline",col=plt.col[2]),
        #text17=list("text",x=60,y=1,text="Subalkaline/Tholeiitic",col=plt.col[2]),
        #text18=list("text",x=40,y=15.5,text="Ultrabasic",col=plt.col[3]),
        #text19=list("text",x=49,y=15.5,text="Basic",col=plt.col[3]),
        #text20=list("text",x=58,y=15.5,text="Intermediate",col=plt.col[3]),
        #text21=list("text",x=68,y=15.5,text="Acid",col=plt.col[3])
        )
...
sheet<<-list(demo=list(fun="plot",call=list(xlim=c(34,90),ylim=c(0,19),main=annotate("Middlemost (1994)"),col="green",bg="transparent",fg="black",xlab=annotate("SiO2"),ylab=annotate("Na2O+K2O")),main="TAS diagram for plutonites (Middlemost 1994)",template=temp))
}
