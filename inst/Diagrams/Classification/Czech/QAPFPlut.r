...
template<-list(
clssf=list("NULL",use=2:28,rcname=c("kvarcolit","køemenem-bohatý granitoid","alk-fsp. granite","syenogranit","monzogranit","granodiorit","tonalit","0","kvarc syenit","kvarcmonzonit","q-monzodiorit q-monzogabro","kvarcdiorit kvarcgabro kvarcanort.","alkalicko-živcový syenit","syenit","monzonit","monzodiorit monzogabro","diorite gabbro anorthosite","alk.-živcový syenit s foidy","syenit s foidy","monzonit s foidy","monzodiorit s foidy monzogabro s foidy","foid-bearing-diorite foid-bearing-gabbro foid-bearing-anorthosite","foidový syenit","foidový monzosyenit","foidový monzosyenit monzogabbro","foidový diorit/foidové gabro","foidolit")),
...
uppertext<-list(    
text1=list("text",x=50,y=80,text="kvarcolit",col=plt.col[2]), 
text2=list("text",x=50,y=60,text="køemenem-bohatý\ngranitoid",col=plt.col[2]), 
text3=list("text",x=22,y=35,text="alk-živ.granit",col=plt.col[2],srt=60),
text4=list("text",x=34,y=35,text="syeno-\ngranit",col=plt.col[2]),
text5=list("text",x=50,y=35,text="monzo-\ngranit",col=plt.col[2]),
text6=list("text",x=66,y=35,text="grano-\ndiorit",col=plt.col[2]),
text7=list("text",x=78,y=35,text="tonalit",col=plt.col[2],srt=-60),
text8=list("text",x=10,y=11,text="0",col=plt.col[2],adj=1),
text9=list("text",x=27,y=11,text="kvarc\nsyenit",col=plt.col[2]),
text10=list("text",x=50,y=11,text="kvarc-\nmonzonit",col=plt.col[2]),
text11=list("text",x=73,y=11,text="q-monzodiorit\nq-monzogabro",col=plt.col[2]),
text12=list("text",x=88,y=11,text="kvarcdiorit\nkvarcgabro\nkvarcanort.",col=plt.col[2],adj=0),
text13=list("text",x=7,y=2,text="1",col=plt.col[2],adj=1),
text14=list("text",x=22,y=2,text="syenit",col=plt.col[2],adj=0.5),
text15=list("text",x=50,y=2,text="monzonit",col=plt.col[2],adj=0.5),
text16=list("text",x=78,y=2,text="2",col=plt.col[2],adj=0.5),
text17=list("text",x=93,y=2,text="3",col=plt.col[2],adj=0),
text18=list("text",x=0,y=80,text="1 - alkalicko-živcový\nsyenit",col=plt.col[2],adj=0),
text19=list("text",x=0,y=68,text="2 - monzodiorit\nmonzogabro",col=plt.col[2],adj=0),
text20=list("text",x=0,y=56,text="3 - diorit, gabro",col=plt.col[2],adj=0)
)

lowertext<-list( 
text21=list("text",x=7,y=-4,text="4",col=plt.col[2],adj=0.5),
text22=list("text",x=22,y=-4,text="syenit\ns foidy",col=plt.col[2],adj=0.5),
text23=list("text",x=50,y=-4,text="monzonit\ns foidy",col=plt.col[2],adj=0.5),
text24=list("text",x=78,y=-4,text="5",col=plt.col[2],adj=0.5),
text25=list("text",x=93,y=-4,text="6",col=plt.col[2],adj=0.5),
text26=list("text",x=23,y=-35,text="foidový syenit",col=plt.col[2],adj=0.5,srt=-60),
text27=list("text",x=37,y=-20,text="foidový\nmonzosyenit",col=plt.col[2],adj=0.5),
text28=list("text",x=63,y=-20,text="foidový\nmonzodiorit\nmonzogabro",col=plt.col[2],adj=0.5),
text29=list("text",x=79,y=-30,text="foidový diorit/foidové gabro",col=plt.col[2],adj=0.5,srt=63),
text30=list("text",x=50,y=-60,text="foidolit",col=plt.col[2],adj=0.5),
text34=list("text",x=0,y=-60,text="4 - alk.-živcový\nsyenit s foidy",col=plt.col[2],adj=0),
text35=list("text",x=0,y=-72,text="5 - monzodiorit s foidy\nmonzogabro s foidy",col=plt.col[2],adj=0),
text36=list("text",x=0,y=-84,text="6 - diorit s foidy\ngabro s foidy\nanortozit s foidy",col=plt.col[2],adj=0)
)
...
if (getOption("gcd.plot.text")){
    if (triangle=="upper") {template<-c(template,upper,uppertext);ylim<-c(-3,103);main<-"QAPF diagram - Si nasycené horniny"}
    if (triangle=="lower") {template<-c(template,lower,lowertext);ylim<-c(-103,3);main<-"QAPF diagram - Si nenasycené horniny"}
    if (triangle=="both") {template<-c(template,upper,lower,uppertext,lowertext);ylim<-c(-103,103);main<-"QAPF diagram"}
}else{
    if (triangle=="upper") {template<-c(template,upper);ylim<-c(-3,103);main<-"QAPF diagram - Si nasycené horniny"}
    if (triangle=="lower") {template<-c(template,lower);ylim<-c(-103,3);main<-"QAPF diagram - Si nenasycené horniny"}
