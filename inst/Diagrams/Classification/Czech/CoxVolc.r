...
template<-list(
      clssf=list("NULL",use=2:16,rcname=c("bazalt","bazaltický andezit","andezit","dacit","ryolit","hawaiit","trachyandezit","bazanit/tefrit","mugearit","benmoreit","trachyt","nefelinit","fonolitický nefelinit","fonolitický tefrit","fonolit")),
...
if(getOption("gcd.plot.text")){
    template<-c(template,list(
        text1=list("text",x=70,y=8.5,text="Ryolit",col=plt.col[2]),
        text2=list("text",x=65.5,y=6.5,text="Dacit",col=plt.col[2]),
        text3=list("text",x=59,y=4.5,text="Andezit",col=plt.col[2]),
        text4=list("text",x=48,y=4,text="Bazalt",col=plt.col[2]),
        text5=list("text",x=64,y=11.5,text="Trachyt",col=plt.col[2]),
        text6=list("text",x=51.5,y=8,text="Mugearit",col=plt.col[2]),
        text7=list("text",x=56,y=13.5,text="Fonolit",col=plt.col[2]),
        text8=list("text",x=49.1,y=6.3,text="Hawaiit",col=plt.col[2]),
        text9=list("text", x=39.5,y=7,text="Nefelinit",col=plt.col[2]),
        text11=list("text",x=59,y=8,text="Trachy-\nandezit",col=plt.col[2],cex=1),
        text12=list("text",x=53.5,y=4,text="Bazaltický\nandezit",col=plt.col[2],cex=1,srt=90),
        text13=list("text",x=56.5,y=10,text="Benmoreit",col=plt.col[2],cex=1),
        text14=list("text",x=45,y=11,text="Fonolitický\nnefelinit",col=plt.col[2],cex=1,srt=45),
        text15=list("text",x=50,y=10.4,text="Fonolitický\ntefrit",col=plt.col[2],cex=1,srt=45),
        text16=list("text",x=43,y=6,text="Bazanit\ntephrite",col=plt.col[2],cex=1,srt=45)
        )
    )
}
...
if(alkline){
    ...
    if(getOption("gcd.plot.text")){
        template<-c(template,list(
            text11=list("text",x=39,y=2,text="Alkalický",col=plt.col[3],font=4),
