...
template<-list(
clssf=list("NULL",use=2:21,rcname=c("undefined","alk-fsp. ryolit","ryolit","dacit","alk-živ. trachyt","quartz trachyt","quartz latit","bazalt andezit","alkalickoživcový trachyt","trachyt","latit","alkalicko-živcový trachyt s foidy","foid-bearingtrachyt","latit s foidy","fonolit","tefritický fonolit","fonolitický bazanit/tefrit","fonolitický foidit","tefritický foidit","foidit")),
...
uppertext<-list(    
text3=list("text",x=22,y=35,text="alk-živ.ryolit",col=plt.col[2],srt=60),
text4=list("text",x=42,y=35,text="ryolit",col=plt.col[2]),
text6=list("text",x=70,y=35,text="dacit",col=plt.col[2]),
text8=list("text",x=10,y=11,text="alk-živ.\ntrachyt",col=plt.col[2],adj=1),
text9=list("text",x=27,y=11,text="kvarc-\ntrachyt",col=plt.col[2]),
text10=list("text",x=50,y=11,text="kvarc-\nlatit",col=plt.col[2]),
text11=list("text",x=77,y=9,text="bazalt\nandezit",col=plt.col[2]),
text13=list("text",x=7,y=2,text="1",col=plt.col[2],adj=1),
text14=list("text",x=22,y=2,text="trachyt",col=plt.col[2],adj=0.5),
text15=list("text",x=50,y=2,text="latit",col=plt.col[2],adj=0.5),
text18=list("text",x=0,y=80,text="1 - alkalicko-\nživcový\ntrachyt",col=plt.col[2],adj=0)
)

lowertext<-list(
text21=list("text",x=7,y=-4,text="4",col=plt.col[2],adj=0.5),
text22=list("text",x=22,y=-4,text="foid-bearing-\ntrachyt",col=plt.col[2],adj=0.5),
text23=list("text",x=50,y=-4,text="latit\ns foidy",col=plt.col[2],adj=0.5),
text26=list("text",x=23,y=-35,text="fonolit",col=plt.col[2],adj=0.5,srt=-60),
text27=list("text",x=36,y=-20,text="tephritic fonolit",col=plt.col[2],adj=0.5),
text28=list("text",x=65,y=-20,text="fonolitický\nbazanit/tefrit",col=plt.col[2],adj=0.5),
text29=list("text",x=79,y=-30,text="bazanit/tefrit",col=plt.col[2],adj=0.5,srt=63),
text30=list("text",x=49,y=-60,text="fonolitický\nfoidit",col=plt.col[2],adj=1),
text30=list("text",x=51,y=-60,text="tefritický\nfoidit",col=plt.col[2],adj=0),
text1=list("text",x=50,y=-80,text="foidit",col=plt.col[2]),
text34=list("text",x=0,y=-70,text="4 - alkalicko-živcový\ntrachyt s foidy",col=plt.col[2],adj=0)
)
if (triangle=="auto"){
