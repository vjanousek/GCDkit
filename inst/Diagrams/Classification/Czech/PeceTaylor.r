...
temp1<-list(
        clssf=list("NULL",use=2:5,rcname=c("tholeiitová série","vápenato-alkalická série","high-K vápenato-alkalická série","šošonitická série")),
...
temp3<-list(
        text1=list("text",x=77,y=0.7,text="Tholeiitová série",col=plt.col[2],adj=c(1,0.5)),
        text2=list("text",x=77,y=2.4,text="Vápenato-alkalická\nsérie",col=plt.col[2],adj=c(1,0.5)),
        text3=list("text",x=77,y=4,text="Vysoce-draselná\nvápenato-alkalická\nsérie",col=plt.col[2],adj=c(1,0.5)),
        text4=list("text",x=47,y=4.5,text="Šošonitická série",col=plt.col[2],adj=0)
    )
...
sheet<<-list(demo=list(fun="plot",call=list(xlim=c(45,78),ylim=c(0,7),main=annotate("Diagram SiO2-K2O (Pecerillo a Taylor 1976)"),col="green",bg="transparent",fg="black",xlab=annotate("SiO2"),ylab=annotate("K2O")),template=temp))
}
