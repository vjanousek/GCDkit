...
template<-list(
        clssf=list("NULL",use=2:6,rcname=c("køemenný keratofyr","ryolit","køemenný latit","ryodacit","dacit")),
...
temp<-list(        
        text1=list("text",x=20,y=sqrt(3)*10/2,text="Køemenný\nkeratofyr",col=plt.col[2]),
        text2=list("text",x=40+7/2,y=sqrt(3)*7/2,text="Ryolit",col=plt.col[2]),
        text3=list("text",x=42+25/2,y=sqrt(3)*25/2,text="Køemenný\nlatit",col=plt.col[2],srt=60),
        text4=list("text",x=27+30/2,y=sqrt(3)*30/2,text="Ryodacit",col=plt.col[2],srt=60),
        text5=list("text",x=10+40/2,y=sqrt(3)*40/2,text="Dacit",col=plt.col[2])
        )
