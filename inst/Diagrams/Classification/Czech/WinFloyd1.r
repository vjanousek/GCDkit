...
WinFloyd1<-function(){
template=list(
    clssf=list("NULL",use=2:12,rcname=c("Trachyandezit","Alk-Baz","Basanite/Nephelinite","Trachyt","Fonolit","Comendit/Pantellerit","Ryolit","Ryodacit/Dacit","Andezit","Andezit/Bazalt","Subalkalický Bazalt")),
  ...
  if(getOption("gcd.plot.text")){
    template<-c(template,list(
        text1=list("text",x=4,y=2,text="Fonolit",col=plt.col[2],cex=1,adj=0),
        text2=list("text",x=2,y=0.15,text="Trachyt",col=plt.col[2],cex=1,adj=0),
        text3=list("text",x=.2,y=.3,text="Ryolit",col=plt.col[2],cex=1,adj=0),
        text4=list("text",x=0.02,y=0.008,text="Andezit/Bazalt",col=plt.col[2],cex=1,adj=0),
        text5=list("text",x=0.02,y=.1,text="Ryodacit/Dacit",col=plt.col[2],cex=1,adj=0),
        text6=list("text",x=0.04,y=.002,text="Subalkalický Bazalt",col=plt.col[2],cex=1,adj=0),
        text7=list("text",x=1,y=0.05,text="Trachy-\nandezit",col=plt.col[2],cex=1,adj=0),
        text8=list("text",x=1,y=0.003,text="Alk-Baz",col=plt.col[2],cex=1,adj=0),
        text9=list("text",x=0.5,y=2,text="Comendit\nPantellerit",col=plt.col[2],cex=1,adj=0),
        text10=list("text",x=3.5,y=0.01,text="Basanite\nNephelinite",col=plt.col[2],cex=1,adj=0),
        text11=list("text",x=.015,y=.04,text="Andezit",col=plt.col[2],cex=1,adj=0)))
}
...
#}
#}
sheet<<-list(demo=list(fun="plot",call=list(xlim=c(0.01,10),ylim=c(0.001,5),main=annotate("Nb/Y - Zr/TiO2 diagram (Winchester a Floyd 1977)"),bg="transparent",fg="black",asp=1,axes=TRUE,log="xy",xlab="Nb/Y",ylab=annotate("Zr/TiO2")),template=template))
}
