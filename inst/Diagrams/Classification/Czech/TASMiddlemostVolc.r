...
temp1<-list(clssf=list("NULL",use=2:19,rcname=c("foidit","pikrobazalt","bazalt","bazaltický andezit","andezit","dacit","ryolit","trachybazalt","bazaltic trachyandezit","trachyandezit","trachydacit","trachyt","tefrit","phonotefrit","tephrifonolit","fonolit","sodalitit/nefelinolit/leucitolit","silexit")),
...
temp2<-list(
        text1=list("text",x=43,y=1.4,text="Pikro-\nbazalt",col=plt.col[2],srt=90),
        text2=list("text",x=48.5,y=2.8,text="Bazalt",col=plt.col[2],srt=90),
        text3=list("text",x=54.8,y=3,text="Bazaltický\nandezit",col=plt.col[2],srt=90),
        text4=list("text",x=59.9,y=3,text="Andezit",col=plt.col[2],srt=90),
        text5=list("text",x=67,y=3,text="Dacit",col=plt.col[2],srt=90),
        text6=list("text",x=80,y=6,text="Ryolit",col=plt.col[2]),
        text7=list("text",x=63.5,y=11.5,text="Trachyt",col=plt.col[2]),
        text22=list("text",x=66,y=9,text="Trachy-\ndacit",col=plt.col[2],cex=0.8,srt=50),
        text8=list("text",x=57.8,y=8.5,text="Trachy-\nandezit",col=plt.col[2],cex=0.8),
        text9=list("text",x=52.95,y=7,text="Bazaltický\ntrachy-\nandezit",col=plt.col[2],cex=0.8),
        text10=list("text",x=49.2,y=5.65,text="Trachy-\nbazalt",col=plt.col[2],cex=0.8),
        text11=list("text",x=45,y=7,text="Tefrit",col=plt.col[2],srt=50),
        text12=list("text",x=49.2,y=9.3,text="Fono-\ntefrit",col=plt.col[2],cex=0.8,srt=50),
        text13=list("text",x=53,y=11.5,text="Tefri-\nfonolit",col=plt.col[2],cex=0.8,srt=50),
        text14=list("text",x=57,y=15,text="Fonolit",col=plt.col[2]),
        text15=list("text",x=44,y=12,text="Foidit",col=plt.col[2]),
        text22=list("text",x=55,y=18.5,text="Sodalitit/Nefelinolit/Leucitolit",col=plt.col[2]),
        text23=list("text",x=85,y=1,text="Silexit",col=plt.col[2])
        )
...
sheet<<-list(demo=list(fun="plot",call=list(xlim=c(34,90),ylim=c(0,19),main=annotate("TAS (Middlemost 1994)"),col="green",bg="transparent",fg="black",xlab=annotate("SiO2"),ylab=annotate("Na2O+K2O")),main="TAS diagram pro vulkanity (Middlemost 1994)",template=temp))
}
