...
template=list(
    clssf=list("NULL",use=2:11,rcname=c("TrAn","Basanita/Traquibasanita/Nefelinita","Fonolita","Traquita","Comendita/Pantelerita","Riolita","Riodacita/Dacita","Andesita","Sub-AB","AB")),
...
if(getOption("gcd.plot.text")){
    ...
    text1=list("text",x=1,y=55,text="Fonolita",col=plt.col[2],cex=1,adj=0),
    text1=list("text",x=1,y=65,text="Traquita",col=plt.col[2],cex=1,adj=0),
    text1=list("text",x=0.002,y=75,text="Riolita",col=plt.col[2],cex=1,adj=0),
   #text1=list("text",x=0.02,y=60,text="Andesita",col=plt.col[2],cex=1,adj=0),
    text1=list("text",x=0.002,y=70,text="Riodacita\nDacita",col=plt.col[2],cex=1,adj=0),
    ...
    text1=list("text",x=1,y=75,text="Comendita\nPantelerita",col=plt.col[2],cex=1,adj=0),
    text1=list("text",x=0.03,y=46,text="Basanita\nTraquibasanita\nNefelnita",col=plt.col[2],cex=1,adj=0),
    text1=list("text",x=.002,y=60,text="Andesita",col=plt.col[2],cex=1,adj=0)))
}
...
sheet<<-list(demo=list(fun="plot",call=list(xlim=c(0.001,10),ylim=c(40,80),main=annotate("Diagrama Zr/TiO2-SiO2 (Winchester y Floyd 1977)"),bg="transparent",fg="black",asp=1,axes=TRUE,log="x",xlab=annotate("Zr/TiO2"),ylab=annotate("SiO2")),template=template))
