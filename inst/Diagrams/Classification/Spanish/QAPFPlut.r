...
template<-list(
clssf=list("NULL",use=2:28,rcname=c("quarzolita","granitoide rico en cuarzo","alk-fsp. granite","sienogranito","monzogranito","granodiorita","tonalita","sienita cz-fsp-alc","sienita cuarcífera","cuarzomonzonita","cuarzomonzonita cz. monzogabro","cz.diorita cz.gabro cz.anortosita","sientia\alcalí-felsp.","sienita","monzonita","monzodiorita monzogabro","diorite gabbro anorthosite","sienita feldespática alcalína con-feldespatoide","sienita  feldespatoides","monzonita  feldespatoides","monzodiorita/monzogabro  feldespatoide","foid-bearing-diorite foid-bearing-gabbro foid-bearing-anorthosite","sienita\nfeldespatoide","monzosientia feldespatoide","monzosientia feldespatoide monzogabbro","diorita/gabro feldespatoide","feldespatodilita")),
...
uppertext<-list(    
text1=list("text",x=50,y=80,text="quarzolita",col=plt.col[2]), 
text2=list("text",x=50,y=60,text="granitoide\nrico en cuarzo",col=plt.col[2]), 
text3=list("text",x=22,y=35,text="granito alc.-felsp.",col=plt.col[2],srt=60),
text4=list("text",x=34,y=35,text="sieno-\ngranito",col=plt.col[2]),
text5=list("text",x=50,y=35,text="monzo-\ngranito",col=plt.col[2]),
text6=list("text",x=66,y=35,text="grano-\ndiorita",col=plt.col[2]),
text7=list("text",x=78,y=35,text="tonalita",col=plt.col[2],srt=-60),
text8=list("text",x=10,y=11,text="sienita\nCz-fsp-alc",col=plt.col[2],adj=1),
text9=list("text",x=27,y=11,text="sienita\ncuarcífera",col=plt.col[2]),
text10=list("text",x=50,y=11,text="cuarzo-\nmonzonita",col=plt.col[2]),
text11=list("text",x=73,y=11,text="cuarzomonzonita\ncz. Monzogabro",col=plt.col[2]),
text12=list("text",x=88,y=11,text="cz.diorita\ncz.gabro\ncz.anortosita",col=plt.col[2],adj=0),
text13=list("text",x=7,y=2,text="1",col=plt.col[2],adj=1),
text14=list("text",x=22,y=2,text="sienita",col=plt.col[2],adj=0.5),
text15=list("text",x=50,y=2,text="monzonita",col=plt.col[2],adj=0.5),
text16=list("text",x=78,y=2,text="2",col=plt.col[2],adj=0.5),
text17=list("text",x=93,y=2,text="3",col=plt.col[2],adj=0),
text18=list("text",x=0,y=80,text="1 - sientia\alcalí-felsp.",col=plt.col[2],adj=0),
text19=list("text",x=0,y=68,text="2 - monzodiorita\nmonzogabro",col=plt.col[2],adj=0),
text20=list("text",x=0,y=56,text="3 - diorita, gabro",col=plt.col[2],adj=0)
)

lowertext<-list( 
text21=list("text",x=7,y=-4,text="4",col=plt.col[2],adj=0.5),
text22=list("text",x=22,y=-4,text="sienita\n feldespatoides",col=plt.col[2],adj=0.5),
text23=list("text",x=50,y=-4,text="monzonita\n feldespatoides",col=plt.col[2],adj=0.5),
text24=list("text",x=78,y=-4,text="5",col=plt.col[2],adj=0.5),
text25=list("text",x=93,y=-4,text="6",col=plt.col[2],adj=0.5),
text26=list("text",x=23,y=-35,text="sienita\nfeldespatoide",col=plt.col[2],adj=0.5,srt=-60),
text27=list("text",x=37,y=-20,text="monzosientia\nfeldespatoide",col=plt.col[2],adj=0.5),
text28=list("text",x=63,y=-20,text="monzosienita\nmonzogabro\nfeldespatoide",col=plt.col[2],adj=0.5),
text29=list("text",x=79,y=-30,text="diorita/gabro feldespatoide",col=plt.col[2],adj=0.5,srt=63),
text30=list("text",x=50,y=-60,text="feldespatodilita",col=plt.col[2],adj=0.5),
text34=list("text",x=0,y=-60,text="4 - sienita feldespática alcalína\ncon-feldespatoide",col=plt.col[2],adj=0),
text35=list("text",x=0,y=-72,text="5 - monzodiorita/monzogabro\n feldespatoide",col=plt.col[2],adj=0),
text36=list("text",x=0,y=-84,text="6 - diorita/gabro con feldespatoides",col=plt.col[2],adj=0)
)
...
if (getOption("gcd.plot.text")){
    if (triangle=="upper") {template<-c(template,upper,uppertext);ylim<-c(-3,103);main<-"Diagrama QAPF - Sobresaturadas en Si"}
    if (triangle=="lower") {template<-c(template,lower,lowertext);ylim<-c(-103,3);main<-"Diagrama QAPF - Insaturadas en Si"}
    if (triangle=="both") {template<-c(template,upper,lower,uppertext,lowertext);ylim<-c(-103,103);main<-"QAPF diagram"}
}else{
    if (triangle=="upper") {template<-c(template,upper);ylim<-c(-3,103);main<-"Diagrama QAPF - Sobresaturadas en Si"}
    if (triangle=="lower") {template<-c(template,lower);ylim<-c(-103,3);main<-"Diagrama QAPF - Insaturadas en Si"}
