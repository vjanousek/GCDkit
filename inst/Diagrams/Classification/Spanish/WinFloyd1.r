...
WinFloyd1<-function(){
template=list(
    clssf=list("NULL",use=2:12,rcname=c("Trachyandesita","Bas. Alc.","Basanite/Nephelinite","Traquita","Fonolita","Comendita/Pantelerita","Riolita","Riodacita/Dacita","Andesita","Andesita/Basalto","Basalto subalcalino")),
  ...
  if(getOption("gcd.plot.text")){
    template<-c(template,list(
        text1=list("text",x=4,y=2,text="Fonolita",col=plt.col[2],cex=1,adj=0),
        text2=list("text",x=2,y=0.15,text="Traquita",col=plt.col[2],cex=1,adj=0),
        text3=list("text",x=.2,y=.3,text="Riolita",col=plt.col[2],cex=1,adj=0),
        text4=list("text",x=0.02,y=0.008,text="Andesita/Basalto",col=plt.col[2],cex=1,adj=0),
        text5=list("text",x=0.02,y=.1,text="Riodacita/Dacita",col=plt.col[2],cex=1,adj=0),
        text6=list("text",x=0.04,y=.002,text="Basalto subalcalino",col=plt.col[2],cex=1,adj=0),
        text7=list("text",x=1,y=0.05,text="Traqui-\nandesita",col=plt.col[2],cex=1,adj=0),
        text8=list("text",x=1,y=0.003,text="Bas. Alc.",col=plt.col[2],cex=1,adj=0),
        text9=list("text",x=0.5,y=2,text="Comendita\nPantelerita",col=plt.col[2],cex=1,adj=0),
        text10=list("text",x=3.5,y=0.01,text="Basanite\nNephelinite",col=plt.col[2],cex=1,adj=0),
        text11=list("text",x=.015,y=.04,text="Andesita",col=plt.col[2],cex=1,adj=0)))
}
...
#}
#}
sheet<<-list(demo=list(fun="plot",call=list(xlim=c(0.01,10),ylim=c(0.001,5),main=annotate("Diagrama Nb/Y-Zr/TiO2 (Winchester y Floyd 1977)"),bg="transparent",fg="black",asp=1,axes=TRUE,log="xy",xlab="Nb/Y",ylab=annotate("Zr/TiO2")),template=template))
}
