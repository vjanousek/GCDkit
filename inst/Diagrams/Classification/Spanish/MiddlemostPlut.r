...
temp1<-list(
        clssf=list("NULL",use=2:15,rcname=c("D, Gb","monzodiorite","monzonite","sienita","af sientia","diorite","cuarzo monzodiorita","cuarzo monzonita","cuarzo sienita","af qtz sientia","tonalita","granodirite","granito","af granito")),
...
temp2<-list(
        text1=list("text",x=61,y=12,text="Af\nSientia",col=plt.col[2],cex=0.75),
        text2=list("text",x=65,y=11.5,text="Af\nQtz\nSientia",col=plt.col[2],cex=0.75),
        text3=list("text",x=70,y=10.5,text="Af\nGranito",col=plt.col[2],cex=0.75),
        text4=list("text",x=59.5,y=10,text="Sienita",col=plt.col[2],cex=0.75,srt=45),
        text5=list("text",x=64,y=10,text="Cuarzo\nsienita",col=plt.col[2],cex=0.75),
        text6=list("text",x=70,y=8.5,text="Granito",col=plt.col[2],cex=0.75),
        text7=list("text",x=56,y=7.5,text="Mz",col=plt.col[2],cex=0.75),
        text8=list("text",x=61.5,y=8,text="Cuarzo\nmonzonita",col=plt.col[2],cex=0.75),
        text9=list("text",x=50.5,y=5.5,text="Monzo\ndiorita",col=plt.col[2],cex=0.75,srt=45),
        text10=list("text",x=58,y=6.5,text="Cuarzo\nmonzodiorita",col=plt.col[2],cex=0.75),
        text11=list("text",x=68,y=6.4,text="Granodiorita",col=plt.col[2],cex=0.75),
        text12=list("text",x=46.5,y=3.5,text="Dio,\nGb",col=plt.col[2],cex=0.75),
        text13=list("text",x=52,y=4.3,text="Cuarzo\ndiorita",col=plt.col[2],cex=0.75),
        text14=list("text",x=66,y=4.75,text="Tonalita",col=plt.col[2],cex=0.75)
    )
