...
template<-list(
      clssf=list("NULL",use=2:16,rcname=c("basalto","basaltoica andesita","andesita","dacita","riolita","hawaiita","traquiandesita","basanita/tefrita","mugearita","benmoreita","traquita","nefelinita","fonolítica nefelinita","fonolítica tefrita","fonolita")),
...
if(getOption("gcd.plot.text")){
    template<-c(template,list(
        text1=list("text",x=70,y=8.5,text="Riolita",col=plt.col[2]),
        text2=list("text",x=65.5,y=6.5,text="Dacita",col=plt.col[2]),
        text3=list("text",x=59,y=4.5,text="Andesita",col=plt.col[2]),
        text4=list("text",x=48,y=4,text="Basalto",col=plt.col[2]),
        text5=list("text",x=64,y=11.5,text="Traquita",col=plt.col[2]),
        text6=list("text",x=51.5,y=8,text="Mugearita",col=plt.col[2]),
        text7=list("text",x=56,y=13.5,text="Fonolita",col=plt.col[2]),
        text8=list("text",x=49.1,y=6.3,text="Hawaiita",col=plt.col[2]),
        text9=list("text", x=39.5,y=7,text="Nefelinita",col=plt.col[2]),
        text11=list("text",x=59,y=8,text="Traqui-\nandesita",col=plt.col[2],cex=1),
        text12=list("text",x=53.5,y=4,text="Basaltoica\nandesita",col=plt.col[2],cex=1,srt=90),
        text13=list("text",x=56.5,y=10,text="Benmoreita",col=plt.col[2],cex=1),
        text14=list("text",x=45,y=11,text="Fonolítica\nnefelinita",col=plt.col[2],cex=1,srt=45),
        text15=list("text",x=50,y=10.4,text="Fonolítica\ntefrita",col=plt.col[2],cex=1,srt=45),
        text16=list("text",x=43,y=6,text="Basanita\ntephrite",col=plt.col[2],cex=1,srt=45)
        )
    )
}
...
if(alkline){
    ...
    if(getOption("gcd.plot.text")){
        template<-c(template,list(
            text11=list("text",x=39,y=2,text="Alcalina",col=plt.col[3],font=4),
            text12=list("text",x=42,y=1,text="Subalcalina/Toleitica",col=plt.col[3],adj=0,font=4),
            text13=list("text",x=40,y=16,text="Ultrabásica",col=plt.col[3]),
            text14=list("text",x=49,y=16,text="Básica",col=plt.col[3]),
            text15=list("text",x=58,y=16,text="Intermedia",col=plt.col[3]),
            text16=list("text",x=68,y=16,text="Ácida",col=plt.col[3])
            )
        )
    }
}
