...
template<-list(
clssf=list("NULL",use=2:21,rcname=c("undefined","alk-fsp. riolita","riolita","dacita","traquita cz-fsp-alc","quartz traquita","quartz latita","basalto andesita","traquita\alcalí-felsp.","traquita","latita","traquita con fsp. alc  y feldespatoides","foid-bearingtraquita","latita con feldespatoides","fonolita","fonolita tefrítica","tefrita/basanita fonolítica","feldespatoide fonolítica","feldespatoide tefrítica","feldespatoide")),
...
uppertext<-list(    
text3=list("text",x=22,y=35,text="riolita alclí-felsp.",col=plt.col[2],srt=60),
text4=list("text",x=42,y=35,text="riolita",col=plt.col[2]),
text6=list("text",x=70,y=35,text="dacita",col=plt.col[2]),
text8=list("text",x=10,y=11,text="traquita\nCz-fsp-alc",col=plt.col[2],adj=1),
text9=list("text",x=27,y=11,text="traquita\ncuarcífera",col=plt.col[2]),
text10=list("text",x=50,y=11,text="Latita\ncuarcífera",col=plt.col[2]),
text11=list("text",x=77,y=9,text="Basalto\nandesita",col=plt.col[2]),
text13=list("text",x=7,y=2,text="1",col=plt.col[2],adj=1),
text14=list("text",x=22,y=2,text="traquita",col=plt.col[2],adj=0.5),
text15=list("text",x=50,y=2,text="latita",col=plt.col[2],adj=0.5),
text18=list("text",x=0,y=80,text="1 - traquita\alcalí-felsp.",col=plt.col[2],adj=0)
)

lowertext<-list(
text21=list("text",x=7,y=-4,text="4",col=plt.col[2],adj=0.5),
text22=list("text",x=22,y=-4,text="foid-bearing-\ntraquita",col=plt.col[2],adj=0.5),
text23=list("text",x=50,y=-4,text="latita con feldespatoides",col=plt.col[2],adj=0.5),
text26=list("text",x=23,y=-35,text="fonolita",col=plt.col[2],adj=0.5,srt=-60),
text27=list("text",x=36,y=-20,text="tephritic fonolita",col=plt.col[2],adj=0.5),
text28=list("text",x=65,y=-20,text="tefrita/basanita\nfonolítica",col=plt.col[2],adj=0.5),
text29=list("text",x=79,y=-30,text="tefrita/basanita",col=plt.col[2],adj=0.5,srt=63),
text30=list("text",x=49,y=-60,text="feldespatoide\nfonolítica",col=plt.col[2],adj=1),
text30=list("text",x=51,y=-60,text="feldespatoide\ntefrítica",col=plt.col[2],adj=0),
text1=list("text",x=50,y=-80,text="feldespatoide",col=plt.col[2]),
text34=list("text",x=0,y=-70,text="4 - traquita con fsp. Alc\n y feldespatoides",col=plt.col[2],adj=0)
)
if (triangle=="auto"){
