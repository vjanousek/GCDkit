...
NaAlK<-function(){
    ...
    temp1<-list(
        clssf=list("NULL",use=2:7,rcname=c("metaluminous/peraluminous","sódica","peralcalino","potásica","perpotásica","peralcalino","ultrapotásica")),
        ...
        GCDkit=list("NULL",plot.type="ternary",plot.position=13.5,plot.name="Diagrama Na2O-Al2O3-K2O Molar")
        )

    temp2<-list(
        text1=list("text",x=0.45,y=0.05,text="Sódica",col=plt.col[2]), 
        text2=list("text",x=0.58,y=0.05,text="Potásica",col=plt.col[2]),
        text3=list("text",x=0.85,y=0.05,text="Ultrapotásica",col=plt.col[2]),
        text4=list("text",x=0.0,y=0.5,text="Metaluminoso\nPeraluminoso",col=plt.col[2],adj=0),
        text5=list("text",x=0.0,y=0.4,text="Peralcalino",col=plt.col[2],adj=0), 
        text6=list("text",x=0.7,y=0.3,text="Perpotásico",col=plt.col[2],srt=60)
    )
...
sheet<<-list(demo=list(fun="plot",call=list(xlim=c(-.03,1.03),ylim=c(-0.08,1.03),main=annotate("Diagrama Na2O-Al2O3-K2O Molar"),bg="transparent",fg="black",asp=1,axes=FALSE,xlab="",ylab=""),template=temp))
