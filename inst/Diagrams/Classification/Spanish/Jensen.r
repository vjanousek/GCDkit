...
template=list(
        clssf=list("NULL",use=2:12,rcname=c("TH - Riolita","TH - Dacita","TH - Andesita","CA - Riolita","CA - Dacita","CA - Andesita","CA - Basalto","TH - Basaltoo toleítico alto-Mg","KO - Komatiitic basalto","KO - Komatita s.s.","TH - Basaltoo toleítico alto-Fe")),
...
#        lines26=list("lines",x=c(0.320,0.443),y=c(0.3983717,0.3464102),col=plt.col[2],lty="dashed"),  # dtto
  ...
  if(getOption("gcd.plot.text")){
        ...
        text4=list("text",x=0.39,y=0.40,text="Basaltoo\ntoleítico\nalto-Fe",cex=0.85,col=plt.col[2]),
        text5=list("text",x=0.26,y=0.32,text="Andesita",srt=-60,cex=0.85,col=plt.col[2]),
        text6=list("text",x=0.20,y=0.25,text="Dacita",srt=-60,cex=0.85,col=plt.col[2]),
        text7=list("text",x=0.12,y=0.17,text="Riolita",srt=30,cex=0.7,col=plt.col[2]),
        text8=list("text",x=0.095,y=0.046,text="Riolita",srt=-60,cex=0.7,col=plt.col[2]),
        text9=list("text",x=0.20,y=0.074,text="Dacita",srt=-60,cex=0.85,col=plt.col[2]),
        text10=list("text",x=0.285,y=0.117,text="Andesita",srt=-60,cex=0.85,col=plt.col[2]),
        text11=list("text",x=0.35,y=0.163,text="Basalto",srt=-60,cex=0.85,col=plt.col[2]),
        text12=list("text",x=0.445,y=0.17,text="Basaltoo\ntoleítico\nalto-Mg",cex=0.7,col=plt.col[2]),
        text13=list("text",x=0.625,y=0.29,text="Basaltoo\nkomatítico",srt=-60,col=plt.col[2]),
        text14=list("text",x=0.80,y=0.12,text="Komatita",srt=-60,col=plt.col[2]),

        text15=list("text",x=0.414,y=0.30,text="TH",col=plt.col[2]),
        text16=list("text",x=0.368,y=0.043,text="CA",col=plt.col[2]),
        text17=list("text",x=0.75,y=0.27,text="KOMATITA",srt=-60,col=plt.col[2])))
