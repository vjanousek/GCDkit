...
temp1<-list(clssf=list("NULL",use=2:19,rcname=c("foidita","picrobasaltoo","basalto","andesita basáltica","andesita","dacita","riolita","traquibasaltoo","basaltoic trachyandesita","trachyandesita","trachydacita","traquita","tefrita","phonotefrita","tephrifonolita","fonolita","sodalitita/nefelinolita/leucitolita","silexita")),
...
sheet<<-list(demo=list(fun="plot",call=list(xlim=c(34,90),ylim=c(0,19),main=annotate("TAS (Middlemost 1994)"),col="green",bg="transparent",fg="black",xlab=annotate("SiO2"),ylab=annotate("Na2O+K2O")),main="Diagrama TAS para rocas volcánicas (Middlemost 1994)",template=temp))
}
