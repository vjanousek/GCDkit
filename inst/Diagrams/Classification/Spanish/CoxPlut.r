...
template<-list(
      clssf=list("NULL",use=2:12,rcname=c("gabro","gabro","diorita","cuarzo diorita (granitoide)","granito","indefinida","indefinida","sienodiorita","sienita","ijolita","nefilina sienita")),
...
if(getOption("gcd.plot.text")){
    template<-c(template,list(
        text1=list("text",x=70,y=8.5,text="Granito",col=plt.col[2]),
        text2=list("text",x=66,y=6,text="Cuarzo\ndiorita\n(granitoide)",col=plt.col[2]),
        text3=list("text",x=59,y=4.5,text="Diorita",col=plt.col[2]),
        text4=list("text",x=48.5,y=3.5,text="Gabro",col=plt.col[2]),
        text5=list("text",x=64,y=11.5,text="Sienita",col=plt.col[2]),
        text6=list("text",x=51.5,y=8.3,text="Sieno-\ndiorita",col=plt.col[2]),
        text7=list("text",x=56,y=13.5,text="Nefilina\nsienita",col=plt.col[2]),
        text8=list("text",x=49.5,y=6.2,text="Gabro",col=plt.col[2]),
        text9=list("text", x=39,y=6.5,text="Ijolita",col=plt.col[2]),
        text10=list("text",x=56.5,y=10,text="Sienita",col=plt.col[2])
        )
    )
}
...
if(alkline){
    ...
    if(getOption("gcd.plot.text")){
        template<-c(template,list(
            text11=list("text",x=38.5,y=2,text="Alcalina",col=plt.col[3],font=4),
